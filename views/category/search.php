        ...
        foreach ($goods as $good) {?>
            <div class="col-4">
                <div class="product">
                    ...
                    <div class="product-descr">Cостав: <?=$good['composition']?></div>
                    ...
                    <div class="product-buttons">
                        ...
                        <a href="<?=Url::to(['good/index','name'=>$good['link_name']])?>" type="button" class="product-buttons__more btn btn-primary">Подробнее</a>                    </div>
                </div>
            </div>
        <?}} else{?>
